...
public class MinTimeLocalPanel extends MyPanel{
    ...
    private void initComponents() {
        ...
        this.setLayout(null);
        minTimeLocal_Panel.setBounds(0,0,800,400);
        minTimeResult_Panel.setBounds(0,400,800,400);
        minTime19Table_Panel.setBounds(800,0,900,170);
        minTime20Table_Panel.setBounds(800,170,900,230);
        ...
        //点位表格设置
        String[] PointsColumnNames = {"点位","指令坐标X","指令坐标Y","指令坐标Z","指令距离","实际坐标X","实际坐标Y","实际坐标Z","实际距离","使用时间"};
        Object[][] PointsmodelData = new Object[8][10];
        ...
        points_ScrollPane.setPreferredSize(new Dimension(760,310));
        ...
        result_ScrollPane = new JScrollPane(result_Table,
                ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
                ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        result_ScrollPane.setPreferredSize(new Dimension(760,310));
